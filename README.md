#  Hi, ich bin Michel Ange!

Willkommen in meinem Portfolio-Repository.  
Ich liebe es, Ideen in funktionierende Software zu verwandeln – egal ob Web-App, Backend-Service oder Datenanalyse.
...
- **Backend:** Node.js, Django, Java REST  
